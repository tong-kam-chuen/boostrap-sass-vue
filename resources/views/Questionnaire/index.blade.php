...
<div class="container">
    ...
    <div class="col-md-12 col-md-offset-0">
        <h2 class="text-center">Manage Questionnaires</h2>
        <br />
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="date_start">Date_start:</label>
                            <div class="col-sm-10">
                                <input type="date" class="form-control" id="date_start_add" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="date_end">Date_end:</label>
                            <div class="col-sm-10">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="name">Name:</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="name_delete" autofocus />
                                <p class="errorName text-center alert alert-danger hidden"></p>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="date_start">Date_start:</label>
                            <div class="col-sm-10">
                                <input type="date" class="form-control" id="date_start_delete" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="date_end">Date_end:</label>
                            <div class="col-sm-10">
                                <input type="date" class="form-control" id="date_end_delete" />
                            </div>
                        </div>
                    </form>
                    <div class="modal-footer">
